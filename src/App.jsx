...
function NavBar() {
  return (
    <nav className="flex justify-between items-center h-16 px-10 border border-b-2 border-[--nav-bar-border-color] lg:h-20 lg:px-36 lg:border-b">
...
function HeroSection() {
  return (
    <section className="flex flex-col justify-center gap-9 px-6 py-9 lg:flex-row lg:justify-center lg:items-center lg:mt-16 lg:p-0 lg:px-16 lg:gap-16">
      <div className="header-text flex flex-col gap-4 lg:w-[35%] lg:gap-8">
      ...
      <div className="flex justify-center">
        <img
          className="h-[30rem] w-auto rounded-2xl object-cover lg:h-[32.5rem] lg:w-[24rem]"
